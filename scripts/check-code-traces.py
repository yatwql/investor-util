...
PATTERNS: list[tuple[str, str, str]] = [
    ...
    #   注释侧仅捕获无歧义的系列代号形状（_series/系列）与 C1~C21 约束代号。
    #
    ...
    #  架构约束代号（C1~C21）：C+1~21 精确匹配，避免误伤十六进制色值
...
EXCLUDE_LINE: list[str] = [
    ...
    #  不误伤""十六进制色值（C0 非 1~21）""超出 C1~C21 范围"等字面量描述豁免边界
