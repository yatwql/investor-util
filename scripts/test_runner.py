...
MODES: dict[str, dict] = {
    "unit": {
        "marker": "unit",
        "desc": "全量单元测试（含 edge/data，2177 项）",
        "timeout_sec": 720,
        "order": 1,
        "parallel": True,
    },
    "standard": {
        ...
        "desc": "常规单元测试（排除 edge/data 标记，1896 项）",
        "timeout_sec": 720,
        "order": 2,
        "parallel": True,
    },
    "scenario": {
        "marker": "scenario",
        "desc": "业务场景集成测试（S0-S33 + T1-T21，240 项）",
        "timeout_sec": 300,
        "order": 3,
        "parallel": False,
    },
    ...
    "integration": {
        ...
        "desc": "集成测试（场景+模块契约/缓存/TUI 路由 265 项）",
        "timeout_sec": 300,
        "order": 6,
        "parallel": True,
    },
    ...
    "all": {
        "marker": "",
        "desc": "全量测试（2442 项，实跑 2430+12 skipped）",
        "timeout_sec": 720,
        "order": 9,
        "parallel": True,
    },
    ...
    "report": {
        "marker": "unit_report",
        "desc": "仅报告模块测试（776 项，开发期快速验证报告变更）",
        "timeout_sec": 120,
        "order": 11,
        "parallel": True,
    },
