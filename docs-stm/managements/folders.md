...
| **源代码合计** | — | **313** | **82,361** | 主程序 + 模板 + 脚本 + SVG |
| **测试代码** | Python | **372** | **108,669** | `src/test/` 所有 `.py` 文件（含近期 ruff format 全仓重排） |
...
| **项目文档** | Markdown | **134** | **51,778** | 含 CLAUDE.md（75 行）；md 口径（managements 10 + plan 2 + archive 121 md），py/txt 不计行 |
| ├ managements/ | 管理文档 | 10 | 10,014 | 变更日志/目录树/测试计划/技术设计/开发者指南等 |
