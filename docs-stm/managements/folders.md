...
| **项目文档** | Markdown | **132** | **50,084** | 含 CLAUDE.md（74 行）；md 口径（managements 10 + plan 2 + archive 119 md），py/txt 不计行 |
| ├ managements/ | 管理文档 | 10 | 10,487 | 变更日志/目录树/测试计划/技术设计/开发者指南等 |
