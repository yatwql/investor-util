...
| **源代码合计** | — | **338** | **90,367** | 主程序 + 模板 + 脚本 + SVG |
| **测试代码** | Python | **398** | **118,293** | `src/test/` 所有 `.py` 文件（含近期 ruff format 全仓重排） |
...
| **项目文档** | Markdown | **145** | **55,713** | 含 CLAUDE.md（75 行）；md 口径（CLAUDE.md 1 + managements 10 + plan 2 + archive md 132），py/txt 不计行 |
