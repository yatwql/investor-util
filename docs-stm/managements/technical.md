...
| `financial_indicator` | 财务指标（数据域 + 报告章：上市公司单报告期结构化指标 + 质量档 + 年度趋势 + 当前 PE/PB） | 财务指标 | 数据获取 | `report_submodules.financial_indicator`（默认关） |
