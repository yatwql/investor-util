...
| 序号 | 任务 | 状态 | 估时 | 说明 |
|:----:|------|:----:|:----:|------|
| 1 | **PRE-01: Rf 国债收益率数据源可用性测试** | 已完成 | 1 天 | 东财 API（`RPTBOND_*`）**已不可用** → 替代源 `bond_zh_us_rate`（akshare/Sina）已通过 50/50 稳定性测试。详见 `docs-stm/plan/better-investment-advice/rf-and-885005-test-report.md` |
