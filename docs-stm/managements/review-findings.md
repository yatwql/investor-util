...
> **2026-08-16 归档**：v0.10.10 ~ v0.10.13 已发布版本修复项（rf-248 ~ rf-275）已整体迁入 [归档档案](#归档档案) 的 `archived_review-findings.0.10.x.md` 对应版本章节；同日按用户要求将仍处 dev 版本的已解决项（rf-276 ~ rf-281，v0.10.14-dev）一并迁入该归档 v0.10.14 章节。**本区当前无已解决项**——后续 changelog [0.10.14-dev] 新增已解决项先登记于此，待 v0.10.14 发布后整体归档。
...
> v0.10.x 已发布版本修复项（rf-204 ~ rf-275）与 v0.10.14-dev 已解决项（rf-276 ~ rf-281）均已迁入 [归档档案](#归档档案) 的 `archived_review-findings.0.10.x.md`。
