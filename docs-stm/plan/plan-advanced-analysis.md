...
>
> **📦 已归档**：**plan-7（因子暴露分析）** 已于 2026-08-02 完成并归档至 `../archive/v0.9.x/factor-exposure/plan-factor-exposure.md`（本文档 §4 全部内容已迁移），不再在本文档跟踪。本文档仅保留 plan-4（已放弃）、plan-5（What-if）、plan-6（趋势）内容。
