...
### I-02: 提取命中率统计 → `_stats.py`（先于 `_store.py` 提取）
...
### I-05: 提取过期清理 + 组管理 → `_cleanup.py` + `_groups.py`
...
### I-06: 提取持仓跟踪 → `src/python/services/holdings_tracker.py`
...
### I-07: 删除 `_legacy.py` + 全量文档同步 + 开发者指引
