...
> 归档时间：2026-09-15（v0.11.0 发布当日并入）；2026-09-18 增补（v0.11.1 发布当日并入）
> 原始文件：`docs-stm/managements/changelog.md`
> 涵盖版本：v0.11.0（2026-09-15）/ v0.11.1（2026-09-18）
> 归档内容：v0.11.x 已发布版本变更记录（含 v0.11.1：同花顺 key 在报告中的可见性、新闻去重校准体系修整、48 小时技术债整改；开发版本记录仍保留在原文件 changelog.md 的 [0.11.2-dev] 段）
