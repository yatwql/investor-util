...
全部 28 项开关分三组（⚗实验 4 / 常规 16 / 报告章节与增强 8），**三组在 TUI 菜单 [S] / Web 配置面板 / CLI 中同样可切换**。
