...
| 个股财务指标（基本面） | akshare `stock_financial_abstract`（东方财富关键指标，宽表） | 财报全文解析（待接入） | `fin_indicator_` | 基础类 |
...
| 个股财务指标 | 季报/年报披露后（随定期报告） | akshare 转结构化关键指标（营收/净利/同比/毛利率/ROE/负债率/现金流/EPS/每股净资产）；金额单位元、比率小数比例；无需凭据 |
