...
个人投资分析报告生成小助手：读取持仓 Excel → 生成 Excel/HTML 报告（含行情、穿透、基金业绩、新闻关联、LLM 宏观/复盘分析）。
...
- **管理文档**：`docs-stm/managements/`（plan.md, requirements.md, technical.md,testplan.md, review-finding.md,changelog.md）
