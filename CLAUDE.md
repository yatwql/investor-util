...
- **用户文档**：`README.md`（总入口）+ `docs-stm/manuals/`（分册：how-to-start.md, how-to-use-cli-mode.md, how-to-use-web-mode.md, how-to-use-tui-menu.md, how-to-config.md, how-to-config-llm.md, how-to-use-registry.md, datasource.md, datasource-reliability.md, reports-instruction.md, faq.md, how-to-test-my-code.md, scripts-reference.md）
- **文件归属三原则**：
