...
- **新增测试隔离要求（迭代 better-investment-advice）**：
  ...
  - **输入数据隔离**：管线集成测试（P1-16、P2-14-B）**不得**依赖真实持仓文件，必须使用 fixture 构造最小持仓（2-5 品种）或 mock 持仓数据。`data/holdings/` 的真实文件在测试中应视为只读
...
- **用户文档**：`README.md`（总入口）+ `docs-stm/manuals/`（分册：how-to-start.md, how-to-menu.md,how-to-config.md, how-to-config-llm.md, how-to-use-registry.md, datasource.md, reports-instruction.md, faq.md, how-to-test-my-code.md, how-to-schedule.md）
- **文件归属三原则**：
