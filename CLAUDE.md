...
- **用户文档**：`README.md`（总入口）+ `docs-stm/manuals/`（分册：how-to-start.md, how-to-use-web-mode.md, how-to-use-tui-menu.md, how-to-use-cli-mode.md, how-to-config.md, how-to-config-llm.md, reports-instruction.md, datasource.md, datasource-reliability.md, faq.md, how-to-use-registry.md）
- **文件归属三原则**：
