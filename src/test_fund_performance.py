...
from src.report import fund_performance as fp
...
class TestFundDisplayType(unittest.TestCase):
    ...
    @patch("src.report.fund_performance.classify_penetration")
...
class TestWriteFundPerformanceSheet(unittest.TestCase):
    ...
    _PATCH_TARGETS = [
        "src.report.fund_performance.write_title_row",
        "src.report.fund_performance.write_header_row",
        "src.report.fund_performance.write_data_row",
        "src.report.fund_performance.freeze_header",
        "src.report.fund_performance.auto_width",
        "src.report.fund_performance.fetch_fund_rankings",
        "src.report.fund_performance.fetch_fund_benchmark",
        "src.report.fund_performance.classify_penetration",
    ]
