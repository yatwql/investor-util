...
class TestQdiiNavDateConsistency(unittest.TestCase):
    ...
    def _make_us_qdii_detail(self, nav_date: str, trading_day: str) -> dict:
        ...
        with patch("src.python.report.market_value.get_last_trading_day", return_value=trading_day):
    ...
    def test_us_qdii_nav_date_t1(self):
        ...
        detail = self._make_us_qdii_detail(nav_date="2026-06-30", trading_day="2026-07-01")
    ...
    def test_us_qdii_nav_date_t2(self):
        ...
        detail = self._make_us_qdii_detail(nav_date="2026-06-28", trading_day="2026-07-01")
        updated, total, all_updated = price_update_status([detail], "2026-07-01")
    ...
    def test_hk_qdii_nav_date_t1(self):
        ...
        detail = self._make_hk_qdii_detail(nav_date="2026-06-30", trading_day="2026-07-01")
        updated, total, all_updated = price_update_status([detail], "2026-07-01")
        self.assertEqual(updated, 1, "港股 QDII T-1 应视为已更新")

    def test_qdii_today_profit_t(self):
        """QDII 净值日期 = T → today_profit > 0。"""
        detail = self._make_us_qdii_detail(nav_date="2026-07-01", trading_day="2026-07-01")
    ...
    def test_mixed_qdii_types_updated_status(self):
        ...
        us_detail = self._make_us_qdii_detail(nav_date="2026-06-30", trading_day="2026-07-01")
        hk_detail = self._make_hk_qdii_detail(nav_date="2026-07-01", trading_day="2026-07-01")
