...
from src.python.http_client import _should_verify, make_http_client
import pytest
...
class TestMakeHttpClient(unittest.TestCase):
    ...
    @patch("src.python.http_client.httpx.Client")
    @patch("src.python.http_client._SSL_VERIFY", True)
    ...
    @patch("src.python.http_client.httpx.Client")
    @patch("src.python.http_client._SSL_VERIFY", False)
