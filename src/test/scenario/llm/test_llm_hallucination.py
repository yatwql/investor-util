...
pytestmark = [pytest.mark.scenario_llm]
...
# 组合总收益率 = (175000+360000+25000) / (162500+360000+27500) - 1 ≈ 0.148 (14.8%)
# 组合总盈亏 = +64000
...
class TestHallucinationDetection:
    ...
    def test_hallucination_rate_summary(self):
        ...
        # 当前事实校验器应维持假阳性率 <= 2（不误报）
        assert false_positives <= 2, f"假阳性 {false_positives} > 2，需调整容差"
