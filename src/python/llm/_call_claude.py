...
包含 call_claude 单 Provider 调用函数。
"""
...
from src.python.llm._thinking import _DEFAULT_CLAUDE_MODEL, configure_extended_thinking
from src.python.llm.api_base import _check_claude_truncation, _extract_content, call_llm_with_retry
...
def call_claude(
    ...
    推荐仅在智囊团深度复盘（expert_review）场景开启，全球政经局势和
    财经新闻热点与持仓关联分析收益有限。
    ...
    Args:
        ...
        config_field: 配置字段名
        temperature: 温度参数（覆盖 payload 中的值）
