...
def generate_global_macro(
    ...
    system_prompt = llm_config.get("system_prompt_global_macro") or _SYSTEM_MACRO
...
def generate_expert_review(
    ...
    system_prompt = llm_config.get("system_prompt_expert_review") or _SYSTEM_EXPERT
...
def enhance_news_correlation(
    ...
    cache_key = _CACHE_PREFIX_LLM + f"news_correlation_{fingerprint}"
