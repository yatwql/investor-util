...
from src.providers import akshare_extras as ae
...
class TestGetDividendData(unittest.TestCase):
    ...
    @patch("src.providers.akshare_extras.cache_get", return_value=None)
    @patch("src.providers.akshare_extras.cache_set")
    @patch("src.providers.akshare_extras._compute_dividend_fingerprint", return_value="testfp")
    @patch("src.providers.akshare_extras.as_completed")
    @patch("src.providers.akshare_extras.ThreadPoolExecutor")
    ...
    @patch("src.providers.akshare_extras.cache_get")
