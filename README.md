...
**把持仓 Excel 变成决策级投资洞察。** 一个面向个人投资者的本地投资分析引擎——对接中国金融数据源获取实时行情，穿透组合底层资产，融合量化指标、基金评级与 LLM 智囊团深度复盘，生成**图表丰富、可交互的 HTML 报告**与**页签专业、结构清晰的 Excel 报告**，让每一次投资决策都建立在数据之上。
...
- **币种敞口分布** — §12 智囊团深度复盘（币种敞口段落）与 §14 穿透深度分析（国别/币种暴露段落）展示 A股/港股/美股 按市值加权占比，非人民币资产>0% 时附加汇率波动风险提示
